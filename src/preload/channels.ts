...
export const ALLOWED_CHANNEL =
  /^(?:simulate$|(?:app|settings|character|watch|triggers|spells|focus|motes|stock|update|logs|overlays|overlay|audio|dialog|game|achievements|inventory|stats|gear|combat|loot|state):[A-Za-z0-9]+$)/
